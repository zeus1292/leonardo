...
**Akshay Kumar** | AI Product Manager & Builder | Foster City, CA
...
**Working style:**
- I think in systems and build in iterations
- I learn by doing — I'd rather ship a rough prototype than write another spec
- I get energized by finding the intersection of real user pain and AI capability
- I lose momentum when I don't have a clear plan for the week

**What drains me:** Aimless days, undifferentiated job applications, building without a monetization path
...
- Current projects in portfolio: Retail Right, InvestorLens, Research Lens (see portfolio)
- Constraint: Solo builder, so ideas need to be scoped for one person
...
## Key Stakeholders / Network

| Name | Role | Context |
|------|------|---------|
| <!-- TODO --> | Recruiter | <!-- Add as you meet people --> |
| <!-- TODO --> | Hiring Manager | |
| <!-- TODO --> | Peer / Collaborator | |
